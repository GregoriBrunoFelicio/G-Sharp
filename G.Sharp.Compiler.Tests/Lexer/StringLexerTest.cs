...
public class StringLexerTest
{
    ...
    {
        var lexer = new Compiler.Lexer.Lexer("\"hello\"");
    ...
    {
        var lexer = new Compiler.Lexer.Lexer("\"\"");
        var token = StringLexer.Read(lexer);
    ...
    {
        var lexer = new Compiler.Lexer.Lexer("\"unterminated string");
    ...
    {
        var lexer = new Compiler.Lexer.Lexer("\"hello greg\"");
        var token = StringLexer.Read(lexer);
    ...
    {
        var lexer = new Compiler.Lexer.Lexer("\"g$#@!&*()_+=<>[]{}\"");
        var token = StringLexer.Read(lexer);
    ...
    {
        var lexer = new Compiler.Lexer.Lexer("\"line1\\nline2\\tend\"");
        var token = StringLexer.Read(lexer);
