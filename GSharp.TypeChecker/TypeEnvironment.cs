...
public class TypeEnvironment
{
    ...
    private readonly TypeEnvironment? _parentScope;

    public TypeEnvironment(TypeEnvironment? parentScope = null)
    {
    ...
    public bool TryLookup(string name, out GsType type)
    {
        ...
        if (_parentScope is not null)
            return _parentScope.TryLookup(name, out type);
    ...
    /// </summary>
    public TypeEnvironment CreateChildScope() => new TypeEnvironment(this);
}
