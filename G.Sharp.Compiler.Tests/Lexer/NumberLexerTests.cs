...
public class NumberLexerTests
{
    ...
    {
        var lexer = new Compiler.Lexer.Lexer("10.");
        var token = NumberLexer.Read(lexer);
    ...
    {
        var lexer = new Compiler.Lexer.Lexer("10.5x"); 
        var token = NumberLexer.Read(lexer);
    ...
    {
        var lexer = new Compiler.Lexer.Lexer("42.0f");
        var token = NumberLexer.Read(lexer);
    ...
    {
        var lexer = new Compiler.Lexer.Lexer("10.2f;");
        var token = NumberLexer.Read(lexer);
